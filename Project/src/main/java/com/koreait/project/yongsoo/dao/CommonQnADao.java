...
public interface CommonQnADao {
	...
	public List<QnATemDto> getQnAList(int beginRecord, int endRecord); 
	
	// 전체 목록 중 원하는 키워드를 포함할때 검색할 메소드
	// 1. 제목 + 내용
	public int getQnACount1(String searchKeyword);
	public List<QnATemDto> getQnAListByKeyword1(int beginRecord, int endRecord, String searchKeyword);
	
	// 2. 제목만
	public int getQnACount2(String searchKeyword);
	public List<QnATemDto> getQnAListByKeyword2(int beginRecord, int endRecord, String searchKeyword);
	
	// 3.  글작성자
	public int getQnACount3(String searchKeyword);
	public List<QnATemDto> getQnAListByKeyword3(int beginRecord, int endRecord, String searchKeyword);
