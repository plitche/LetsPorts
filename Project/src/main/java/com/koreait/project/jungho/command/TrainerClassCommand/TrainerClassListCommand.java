...
public class TrainerClassListCommand implements CommonVoidCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		totalRecord = trainerClassDao.allClassCount();
		endRecord = endRecord < totalRecord ? endRecord : totalRecord;
		paging = Paging.getPaging("TrainerClassListPage.leo", totalRecord, recordPerPage, page);
		// 모든 클래스목록들을 뿌려주기 위한 작업
		model.addAttribute("MeetingList", trainerClassDao.trainerClassList(beginRecord, endRecord));
