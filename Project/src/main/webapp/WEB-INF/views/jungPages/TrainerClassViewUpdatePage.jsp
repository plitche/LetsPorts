	...
	<div class="TrainerClassInsert_all">
		<form id="insertForm" method="post" enctype="multipart/form-data">
			...
			<div class="blank_bottom">
				...
				<div class="classname"><input type="text" name="meeting_title" value="${getTrainerClassUpdate.meeting_title}" style="font-size: 12px;"/></div>
				
			</div>
			<div class="blank_bottom">
			
				<span id="meetingdate">모임일</span>
				<span class="meetingdate"><input type="date" name="meeting_date" value="${getTrainerClassUpdate.meeting_date}" style="font-size: 12px;"/></span>
			...
			<div class="blank_bottom">
				...
				<span>
					...
					<span id="TrainerClassGatherDate1"><input type="date" name="start_gather_date"  value="${getTrainerClassUpdate.start_gather_date}" style="font-size: 12px;"/></span>
					~<span id="TrainerClassGatherDate2"><input type="date" name="end_gather_date" value="${getTrainerClassUpdate.end_gather_date}" style="font-size: 12px;"/></span>
			...
			<div class="blank_bottom">
				...
				<span>
					<span id="gather_MinAndMax1">최소<input type="text" name="meeting_min"  value="${getTrainerClassUpdate.meeting_min}"style="font-size: 12px;"/></span>
					<span  id="gather_MinAndMax2">최대<input type="text" name="meeting_max"  value="${getTrainerClassUpdate.meeting_max}"style="font-size: 12px;"/></span>
				</span>
            ...
            <script>
				    ...
				    <input type="hidden"	name="meeting_no" value="${getTrainerClassUpdate.meeting_no}"/>
			<div class="blank_bottom">
