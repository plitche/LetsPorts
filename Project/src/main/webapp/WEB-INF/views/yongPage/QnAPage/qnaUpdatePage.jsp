...
<form method="post" id="updateForm">
	<div id="qnaTitle">
		<div>질문 제목</div>
		<input type="text" name="board_qna_title" placeholder="질문 제목을 입력하세요." value="${qnaTemDto.board_qna_title}"/>
	</div>
	<pre id="updateRefer">
	■ 필독 사항
	...
	<div id="qnaContent">
		<div>질문 상세 내용</div>
		<textarea name="board_qna_content" id="summernote" class="summernote">${qnaTemDto.board_qna_content}</textarea>
